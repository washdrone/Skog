  ...
  return (
    <footer className="relative overflow-hidden bg-night-950 text-white/60">
      ...
      <div className="container-page relative">
        {/* Main footer content */}
        <div className="flex flex-col items-center gap-10 py-16 sm:py-20">
          {/* Logo */}
          ...
          <nav className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3" aria-label="Footer-navigation">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-sm font-medium text-white/50 transition-colors duration-300 hover:text-forest-400"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#"
              aria-label="LinkedIn"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-white/40 transition-all duration-300 hover:border-forest-500/40 hover:text-forest-400 hover:bg-forest-600/10"
            >
          ...
          {/* Location */}
          <p className="text-sm text-white/30">Verksamma i hela Sverige</p>
        </div>
