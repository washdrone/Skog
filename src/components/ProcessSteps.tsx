            ...
            {steps.map((step) => (
              <div key={step.number} className="relative group">
                <div className="rounded-2xl bg-white/[0.04] backdrop-blur-sm border border-white/[0.08] p-6 transition-all duration-500 hover:bg-white/[0.08] hover:border-forest-500/30 hover:shadow-lg hover:shadow-forest-500/5">
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-forest-600 text-lg font-bold text-white shadow-lg shadow-forest-600/25 transition-all duration-500 group-hover:shadow-xl group-hover:shadow-forest-500/30 group-hover:scale-110">
                    {step.number}
                  </div>
