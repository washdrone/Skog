...
import { COMPANY, CAPABILITIES, COORDINATE_SYSTEM, DELIVERY_FORMATS } from '@/lib/seo/business-data'
...
export const metadata = buildMetadata({
  ...
  description:
    'TimberDrone levererar drönarbaserad skogsinventering, multispektralanalys och geodata för skogsbruk. Läs om vår metodik och våra tjänster.',
  path: '/om-oss',
})
        ...
        <div className="container-page">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-slate-600 font-body leading-relaxed">
              TimberDrone levererar drönarbaserad datainsamling och analys för skogsbruk.
              Vi arbetar med fotogrammetri, multispektral bildtagning och geodatabearbetning
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 font-body leading-relaxed mb-8">
              ...
              vegetationsindex och 3D-modeller. Resultaten levereras i branschstandardformat
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-slate-600 font-body leading-relaxed">
                  Flygning genomförs med överlappande bildserier. Vid behov används
                  multispektral sensor för vegetationsanalys. Alla data georefereras.
                </p>
              </div>
              <div>
                ...
                <p className="text-slate-600 font-body leading-relaxed">
                  ...
                  Multispektrala bilder kalibreras radiometriskt och processas till
                  vegetationsindex.
                </p>
              </div>
              <div>
